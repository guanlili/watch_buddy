...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [{ title: "毒奶观察室 · 开搞！" }, { name: "description", content: "AI 搭子陪你看球。" }],
  }),
  component: WelcomePage,
});

const INTRO =
  "兄弟姐妹！您可算来了！我是你的赛博陪聊，比赛的时候我是你嘴替，输了跟我一起吐槽，赢了跟我一起吹。不废话了，先告诉我你是哪边的？选个主队，我立马把速效救心丸备好！";
      ...
      <div className="relative mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-4 py-10">
        ...
        <div className="mt-8 grid grid-cols-3 gap-3 text-center text-xs text-muted-foreground">
          {["陪看比赛", "一起吐槽", "一起欢呼"].map((t) => (
            <div
              key={t}
              className="glass rounded-xl px-3 py-2 font-display uppercase tracking-wider"
            >
              {t}
            </div>
          ))}
